# The Tech Blog using MVC <a id="title"></a> [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) <a id="license-badge"></a>

## Description <a id="description"></a>

This is APP for developers who want to write about tech SO THAT they can publish articles, blog posts, and y thoughts and opinions.
